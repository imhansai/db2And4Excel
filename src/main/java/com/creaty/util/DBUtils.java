...
public class DBUtils {
    ...
    public DBUtils(DatabaseInfoModel databaseInfoModel) {
        USERNAME = databaseInfoModel.getDatabaseUserName();
        PASSWORD = databaseInfoModel.getDatabasePassword();
        DRIVER = databaseInfoModel.getDatabaseDriver();
        URL = databaseInfoModel.getDatabaseUrl();
        registeredDriver();
    }
